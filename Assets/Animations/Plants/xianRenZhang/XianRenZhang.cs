...
public class XianRenZhang : CardTM
{
    ...
    public void shootIt()
    {
        Spike spike = PoolManager.Instance.GetObject(BossManager.Instance.GameConf.Spike).GetComponent<Spike>();
        spike.transform.position = shootPoint.position;
        spike.Find();
    }
